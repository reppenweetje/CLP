      ...
      <div className="flex-1 min-w-0">
        <div className="rounded-3xl rounded-tl-md overflow-hidden bg-paper border border-mist-light">
          ...
          <div className="p-4">
            ...
            {u.uses && (
              <div className="flex flex-wrap gap-1.5 mt-3">
                {u.uses.map((t) => (
                  <span
                    key={t}
                    className="text-[11px] px-2.5 py-1 rounded-full bg-canvas-2 text-ink-soft"
                  >
                    {t}
                  </span>
                ))}
            ...
            {unit.note && (
              <div className="text-[12px] text-midnite leading-relaxed mt-3 pt-3 border-t border-mist-light">
                {unit.note}
              </div>
            )}
          </div>
