          ...
          <div className="p-4">
            ...
            {investor?.barRange && (
              <div className="mt-3.5 rounded-2xl bg-canvas-2 border border-mist-light p-3.5">
                <div className="text-[10px] tracking-[0.18em] text-ink-mute uppercase">Indicatief BAR</div>
                <div className="flex items-baseline gap-2 mt-1">
                  <div className="text-[24px] font-semibold text-ink leading-none tabular-nums">{investor.barRange}</div>
                  <div className="text-[12px] text-ink-soft">bruto aanvangsrendement</div>
                </div>
            ...
            {investor?.kernfactoren?.length > 0 && (
              <div className="mt-3.5">
                <div className="text-[10px] tracking-[0.18em] text-ink-mute uppercase mb-2">Drie kernfactoren</div>
            ...
            {benefits?.length > 0 && (
              <div className="mt-3.5">
                <div className="text-[10px] tracking-[0.18em] text-ink-mute uppercase mb-2">Voordelen</div>
                <ul className="space-y-1.5">
                  {benefits.map((b, i) => (
