...
// Bevestigingsdialoog voor de Credion-link in de calc-bubbles.
// Voorkomt misclicks: sliders en knoppen liggen dichtbij elkaar in de
// rendement-/maandlast-calc, en een per-ongeluk-tap naar Credion is
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col justify-end pointer-events-none">
      ...
      <div
        ...
        role="dialog"
        aria-label="Financieringsscan via Credion"
      >
        ...
        <div className="px-5 pt-1 pb-6">
          <div className="text-[11px] tracking-[0.18em] text-midnite uppercase font-medium">Partner Credion</div>
          ...
          <div className="mt-4 rounded-2xl bg-canvas-2 border border-mist-light p-3.5 space-y-2.5 text-[13.5px] text-ink-soft leading-relaxed">
            <div className="flex gap-2.5">
              ...
              <span>Credion belt je <strong className="text-ink">zo snel mogelijk</strong> om de cijfers door te lopen.</span>
            </div>
            <div className="flex gap-2.5">
              <span className="shrink-0 w-1 h-1 rounded-full bg-midnite mt-2" aria-hidden />
            ...
            <div className="flex gap-2.5">
              <span className="shrink-0 w-1 h-1 rounded-full bg-midnite mt-2" aria-hidden />
              <span>We delen je <strong className="text-ink">naam, e-mail en 06</strong> alleen met Credion na jouw bevestiging.</span>
            </div>
          </div>
