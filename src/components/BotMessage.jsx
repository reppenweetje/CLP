  ...
  return (
    <div className="flex gap-2.5 items-start fade-up">
      ...
      <div className={wide ? 'flex-1 min-w-0' : 'max-w-[84%] min-w-0'}>
        <div className="rounded-3xl rounded-tl-md bg-paper border border-mist-light px-4 py-3 text-[16px] leading-relaxed text-ink shadow-[0_1px_0_rgba(15,15,112,0.04)] whitespace-pre-line">
          {rendered}
        </div>
      </div>
    </div>
