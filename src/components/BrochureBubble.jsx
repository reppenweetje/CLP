    ...
    <div className="flex gap-2.5 items-start fade-up">
      ...
      <div className="flex-1 min-w-0">
        <div className="rounded-3xl rounded-tl-md bg-paper border border-mist-light overflow-hidden">
          ...
          <div className="p-4">
            <div className="text-[15px] font-semibold text-ink leading-tight">{projectName} brochure</div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-3 block w-full text-center rounded-full bg-midnite text-paper font-medium py-3 text-[14px] hover:bg-midnite-soft transition active:scale-[0.99]"
            >
              open brochure
            </a>
