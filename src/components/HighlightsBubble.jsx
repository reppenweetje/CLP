    ...
    <div className="flex gap-2.5 items-start fade-up">
      ...
      <div className="flex-1 min-w-0">
        <div className="rounded-3xl rounded-tl-md bg-paper border border-mist-light overflow-hidden">
          <div className="p-4">
            <div className="text-[11px] tracking-[0.18em] text-midnite uppercase font-medium">highlights</div>
            ...
            <div className="mt-3 grid grid-cols-2 gap-2">
              {highlights.slice(0, 6).map((h, i) => (
                ...
                >
                  ...
                  <div className="text-[12px] text-ink-soft leading-snug mt-1">{h.body}</div>
                </div>
              ))}
            </div>
          </div>
