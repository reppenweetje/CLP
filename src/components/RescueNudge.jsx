    ...
    <div className="fixed bottom-4 right-4 z-40 max-w-[320px] animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="rounded-2xl border border-mist-light bg-paper shadow-lg px-4 py-3.5 flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="text-[14px] font-semibold text-ink">Vragen onderweg?</div>
          ...
          <div className="flex items-center gap-1.5 mt-2.5">
            <button
              ...
              className="text-[12.5px] text-paper bg-midnite hover:bg-midnite-soft px-2.5 py-1 rounded-full transition"
            >
              Direct contact
            </button>
            <button
              ...
              className="text-[12.5px] text-ink-mute hover:text-ink px-2 py-1 transition"
            >
              Later
            </button>
          </div>
        ...
        <button
          ...
          onClick={handleDismiss}
          aria-label="Sluit"
          className="text-ink-mute hover:text-ink text-[15px] -mt-1 -mr-1 leading-none p-1"
        >×</button>
      </div>
    </div>
  )
