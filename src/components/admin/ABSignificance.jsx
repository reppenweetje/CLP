  ...
  return (
    <section className="rounded-2xl border border-mist-light bg-paper p-5">
      <header className="mb-4">
        <div className="text-[10px] tracking-[0.18em] text-midnite uppercase font-medium mb-1">CTA varianten</div>
        <h2 className="text-[14px] font-semibold text-ink">A/B significance</h2>
      </header>
        ...
        {stats.variants.map((v) => {
          ...
          return (
            <div key={v.variant} className="grid grid-cols-[60px_1fr_88px] items-center gap-3">
              <div className="text-[12px] font-semibold text-ink uppercase tracking-wider">{v.variant}</div>
              ...
              <div className="text-[11px] text-ink-soft tabular-nums text-right">
      ...
      {single ? (
        <div className="mt-4 pt-3 border-t border-mist-light text-[11.5px] text-ink-mute leading-relaxed">
...
function ComparisonReadout({ c }) {
  ...
  return (
    <div className={'mt-4 rounded-xl border px-4 py-3 ' + toneClasses}>
      <div className="text-[12.5px] font-semibold">{verdict}</div>
      <div className="text-[11.5px] mt-1 leading-relaxed opacity-90">
