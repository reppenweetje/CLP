    ...
    <section className="rounded-2xl border border-mist-light bg-paper p-5">
      <header className="flex items-baseline justify-between gap-3 mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[11px] tracking-[0.18em] text-midnite uppercase font-medium">Live</div>
            <h2 className="text-[15px] font-semibold text-ink">Actief in afgelopen 5 min</h2>
          </div>
        </div>
        <div className="text-[12px] text-ink-mute tabular-nums">{active.length} sessies</div>
      </header>
      {active.length === 0 ? (
        <div className="text-[13px] text-ink-mute leading-relaxed py-1.5">
