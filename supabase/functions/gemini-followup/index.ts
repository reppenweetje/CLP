// Edge Function: gemini-followup (v13)
...
//
// v12 → v13:
//   - prompt.ts: korter, persoonlijker bericht-format. Begroeting blijft
//     "Hi {first_name},", afsluiting wordt nu "Groet, Reppit, de slimme
//     assistent van REPP" (i.p.v. Reppit-intro bovenaan + "Ik help je
//     graag verder."). Brochure-email mention vervangen door zachtere
//     "en als het goed is een mail hierover ontvangen". Beschikbaarheid
//     teruggebracht naar 2 actuele units (was 4) plus kortere sluitvraag.
